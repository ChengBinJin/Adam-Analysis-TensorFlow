...
tf.flags.DEFINE_float('learning_rate', 1e-4, 'initial learning rate for optimizer, default: 0.001')
    ...
    for optimizer in optimizer_options:
        for dropout in dropout_options:
            ...
            for i in range(num_iters):
                ...
                _, loss = solver.train(x_batch, y_batch_cls)

                if i % FLAGS.print_freq == 0:
                    print('{0:7}/{1:7}: Loss: {2:.3f}'.format(i, num_iters, loss))
